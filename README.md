...
2. Загружаем и распаковываем в папку с файлом EX_tractor_N.N.py (текущая версия - EX_tractor_1.3.py) архив с данными корпуса [отсюда](https://disk.yandex.ru/d/TxQSIAHpFDJRrQ)
