...
- Первая версия поискового скрипта была написана для другого проекта при участии [Ильи Козиева](https://github.com/Koziev), верия 1.4 дорабатывалась [Евой Гогуа](https://github.com/evagogua)
...
2. Загружаем и распаковываем в папку с файлом EX_tractor_N.N.py (текущая версия - EX_tractor_1.4.py) архив с данными корпуса [отсюда](https://disk.360.yandex.ru/d/Vp6-m5sYSYULhA)
...
#### Пример запуска
```
...#Sandbox% python3 EX_tractor_1.4.py --dir_in Input_ --rules 24
